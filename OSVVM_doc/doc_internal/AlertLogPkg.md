...
| ---------------------------- | -------------- | --------------------- | ----------- |
| ALERTLOG_BASE_ID             | AlertLogIDType |  0                    |             |
| ALERTLOG_DEFAULT_ID          | AlertLogIDType |  ALERTLOG_BASE_ID + 1 |             |
| OSVVM_ALERTLOG_ID            | AlertLogIDType |  ALERTLOG_BASE_ID + 2 |             |
| REQUIREMENT_ALERTLOG_ID      | AlertLogIDType |  ALERTLOG_BASE_ID + 3 |             |
| OSVVM_SCOREBOARD_ALERTLOG_ID | AlertLogIDType |  OSVVM_ALERTLOG_ID    |             |
| ALERT_DEFAULT_ID             | AlertLogIDType |  ALERTLOG_DEFAULT_ID  |             |
| LOG_DEFAULT_ID               | AlertLogIDType |  ALERTLOG_DEFAULT_ID  |             |
| ALERTLOG_ID_NOT_FOUND        | AlertLogIDType |  -1                   |             |
| ALERTLOG_ID_NOT_ASSIGNED     | AlertLogIDType |  -1                   |             |
| MIN_NUM_AL_IDS               | AlertLogIDType |  32                   |             |
## Types
