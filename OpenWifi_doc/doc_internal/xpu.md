...
| douta                          | input     | wire [(WIFI_TX_BRAM_DATA_WIDTH-1):0]   |                                          |
| cts_toself_bb_is_ongoing       | input     | wire                                   |                                          |
| cts_toself_rf_is_ongoing       | input     | wire                                   |                                          |
...
| slv_reg58                      | wire [C_S00_AXI_DATA_WIDTH-1:0]    |                                                                                                                                        |
| slv_reg59                      | wire [C_S00_AXI_DATA_WIDTH-1:0]    |                                                                                                                                        |
| slv_reg63                      | wire [C_S00_AXI_DATA_WIDTH-1:0]    |                                                                                                                                        |
