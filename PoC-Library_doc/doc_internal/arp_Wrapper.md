...
| MACSeq1_SenderMACAddress_Data         | T_SLV_8                                     |             |
| BCRcv_Error                           | std_logic                                   |             |
...
| MACSeq2_SenderMACAddress_Data         | T_SLV_8                                     |             |
...
| ARPCache_Status                       | T_NET_ARP_ARPCACHE_STATUS                   |             |
...
| -------------------------- | -------- | ------------------------------------------------ | ----------- |
| ARPREQ_TIMEOUTCOUNTER_MAX  | positive |  TimingToCycles(APR_REQUEST_TIMEOUT, CLOCK_FREQ) |             |
