...
| Flags_en                   | std_logic                                       | 	signal Identification_en0							: STD_LOGIC; 	signal Identification_en1							: STD_LOGIC;  |
| TimeToLive_en              | std_logic                                       | 	signal FragmentOffset_en0							: STD_LOGIC; 	signal FragmentOffset_en1							: STD_LOGIC;  |
...
| Flag_DontFragment_d        | std_logic                                       | 	signal Identification_d								: T_SLV_16												:= (others => '0');                    |
| Flag_MoreFragmenta_d       | std_logic                                       |                                                                                              |
| TimeToLive_d               | T_SLV_8                                         | 	signal FragmentOffset_d								: STD_LOGIC_VECTOR(12 downto 0)		:= (others => '0');         |
| Protocol_d                 | T_SLV_8                                         |                                                                                              |
