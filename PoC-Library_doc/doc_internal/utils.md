...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| T_BOOLVEC        | array(natural range <>) of boolean                                                                                                                                                                                     |                                 |
...
| T_IPSTYLE        | (IPSTYLE_UNKNOWN,<br><span style="padding-left:20px"> IPSTYLE_HARD,<br><span style="padding-left:20px"> IPSTYLE_SOFT)                                                                                                  | Intellectual Property (IP) type |
