...
| COUNT_WIDTH_C       | positive |  ite(FWFT_EN_G,<br><span style="padding-left:20px"> ADDR_WIDTH_G+1,<br><span style="padding-left:20px"> ADDR_WIDTH_G)                                                                                                                                                            |  In standard READ_MODE, the effective depth = FIFO_WRITE_DEPTH  In First-Word-Fall-Through READ_MODE, the effective depth = FIFO_WRITE_DEPTH+2  COUNT_WIDTH_C = ADDR_WIDTH_G+1 to report the correct fill count (units of words)                                                                                                                                                                |
