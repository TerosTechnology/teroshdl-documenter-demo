# Entity: GTYE4_CHANNEL

## Diagram

![Diagram](GTYE4_CHANNEL.svg "Diagram")
## Description
...
| RXRATE_delay                     | wire [2:0]   |             |
| TXRATE_delay                     | wire [2:0]   |             |
...
| ----------- | ---- | --------------- | ----------------- |
| MODULE_NAME |      | "GTYE4_CHANNEL" | define constants  |
## Processes
- unnamed: ( @ (trig_attr) )
- unnamed: ( @ (trig_attr) )
- unnamed: (  )
