...
| ---------------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| s_axis_waddr_reg | reg [ADDRESS_WIDTH:0]    | ------------------------------------------------------------------------------  registers ------------------------------------------------------------------------------  Definition of address counters  All the counters are wider with one bit to indicate wraparounds                                                                 |
| m_axis_raddr_reg | reg [ADDRESS_WIDTH:0]    |                                                                                                                                                                                                                                                                                                                                           |
| s_axis_raddr_reg | wire [ADDRESS_WIDTH:0]   | ------------------------------------------------------------------------------  wires ------------------------------------------------------------------------------                                                                                                                                                                      |
...
| s_axis_fifo_fill | wire [ADDRESS_WIDTH:0]   | ------------------------------------------------------------------------------  FIFO write logic - upstream<br>  s_axis_full  - FIFO is full if next write pointer equal to read pointer  s_axis_ready - FIFO is always ready, unless it's full<br> ------------------------------------------------------------------------------        |
| m_axis_fifo_fill | wire [ADDRESS_WIDTH:0]   | ------------------------------------------------------------------------------  FIFO read logic - downstream<br>  m_axis_empty - FIFO is empty if read pointer equal to write pointer  m_axis_valid - FIFO has a valid output data, if it's not empty<br> ------------------------------------------------------------------------------  |
## Constants

| Name       | Type | Value     | Description                                                                                                                                                                      |
| ---------- | ---- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FIFO_DEPTH |      | undefined | ------------------------------------------------------------------------------  local parameters ------------------------------------------------------------------------------  |
## Processes
