...
| regwen_qs                      | logic              |                                                                                                                           |
| ctrl_we                        | logic              |                                                                                                                           |
| ctrl_enable_qs                 | logic              |                                                                                                                           |
| ctrl_enable_wd                 | logic              |                                                                                                                           |
| ctrl_aes_cipher_disable_qs     | logic              |                                                                                                                           |
| ctrl_aes_cipher_disable_wd     | logic              |                                                                                                                           |
| ctrl_fifo_depth_sts_sel_qs     | logic [3:0]        |                                                                                                                           |
| ctrl_fifo_depth_sts_sel_wd     | logic [3:0]        |                                                                                                                           |
| sum_sts_qs                     | logic [23:0]       |                                                                                                                           |
| cmd_req_we                     | logic              |                                                                                                                           |
...
- u_ctrl_aes_cipher_disable: prim_subreg
**Description**
F[aes_cipher_disable]: 1:1

- u_ctrl_fifo_depth_sts_sel: prim_subreg
**Description**
F[fifo_depth_sts_sel]: 19:16

- u_sum_sts: prim_subreg
**Description**
R[sum_sts]: V(False)
