...
| lc_state_valid_d  | logic                             | Continously feed in valid signal for LC state.                                                                                                                                                                                                               |
| lc_state_valid_q  | logic                             | Continously feed in valid signal for LC state.                                                                                                                                                                                                               |
...
| lc_id_state_d     | lc_id_state_e                     |                                                                                                                                                                                                                                                              |
| lc_id_state_q     | lc_id_state_e                     |                                                                                                                                                                                                                                                              |
| lc_clk_byp_req    | lc_tx_t                           |                                                                                                                                                                                                                                                              |
| lc_flash_rma_req  | lc_tx_t                           |                                                                                                                                                                                                                                                              |
| lc_check_byp_en   | lc_tx_t                           |                                                                                                                                                                                                                                                              |
| hashed_token_mux  | lc_token_t                        | Hashed token to compare against.                                                                                                                                                                                                                             |
| fsm_state_raw_q   | logic [FsmStateWidth-1:0]         | This primitive is used to place a size-only constraint on the flops in order to prevent FSM state encoding optimizations.                                                                                                                                    |
| lc_state_raw_q    | logic [LcStateWidth-1:0]          |                                                                                                                                                                                                                                                              |
| lc_cnt_raw_q      | logic [LcCountWidth-1:0]          |                                                                                                                                                                                                                                                              |
| lc_id_state_raw_q | logic [LcIdStateWidth-1:0]        |                                                                                                                                                                                                                                                              |
