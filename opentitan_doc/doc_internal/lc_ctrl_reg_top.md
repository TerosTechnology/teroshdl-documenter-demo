...
| transition_target_qs                | logic [3:0]        |                                                                                                                           |
| transition_target_wd                | logic [3:0]        |                                                                                                                           |
| otp_test_ctrl_re                    | logic              |                                                                                                                           |
| otp_test_ctrl_we                    | logic              |                                                                                                                           |
| otp_test_ctrl_val_qs                | logic [7:0]        |                                                                                                                           |
| otp_test_ctrl_val_wd                | logic [7:0]        |                                                                                                                           |
| otp_test_ctrl_ext_clock_qs          | logic              |                                                                                                                           |
| otp_test_ctrl_ext_clock_wd          | logic              |                                                                                                                           |
| lc_state_re                         | logic              |                                                                                                                           |
| lc_state_qs                         | logic [3:0]        |                                                                                                                           |
...
- u_otp_test_ctrl_val: prim_subreg_ext
**Description**
R[otp_test_ctrl]: V(True)
F[val]: 7:0

- u_otp_test_ctrl_ext_clock: prim_subreg_ext
**Description**
F[ext_clock]: 16:16
