...
| scanmode_i      | input     |                 |                                      |
| reg_tl_d_i      | input     |                 | peripheral interface access          |
| reg_tl_d_o      | output    |                 |                                      |
...
| ---------------- | ----------------------------- | ---------------------------------------------------------------------------------- |
| reg2hw           | rv_core_ibex_reg_reg2hw_t     | Register module                                                                    |
| hw2reg           | rv_core_ibex_reg_hw2reg_t     |                                                                                    |
...
- u_reg_reg: rv_core_ibex_reg_reg_top
