...
| clk                      | input     | wire                             |             |
| rst                      | input     | wire                             |             |
| m_axis_desc_addr         | output    | wire [AXI_ADDR_WIDTH-1:0]        |             |
...
| s_axis_desc_status_len   | input     | wire [LEN_WIDTH-1:0]             |             |
...
| s_axis_desc_addr         | input     | wire [PORTS*AXI_ADDR_WIDTH-1:0]  |             |
...
| m_axis_desc_status_len   | output    | wire [PORTS*LEN_WIDTH-1:0]       |             |
